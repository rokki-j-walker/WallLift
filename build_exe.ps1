...
$ArchivePath = Join-Path $PSScriptRoot "dist\$AppName-$Version-windows-x64.zip"
...
Copy-ResourceFiles -Source (Join-Path $PSScriptRoot "lang") -Destination (Join-Path $DistDir "lang") -Extensions @(".json")
Copy-ResourceFiles -Source (Join-Path $PSScriptRoot "themes") -Destination (Join-Path $DistDir "themes") -Extensions @(".json", ".png") -IgnoredParts @("WallLift_result")
